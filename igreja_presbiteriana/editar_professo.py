...
class Ui_edicao_professos(QtWidgets.QWidget):
    ...
    def setupUi(self, Widget):
      ...
      # 🔹 Forma de admissão com ComboBox
    ...
    def retranslateUi(self, Widget):
        ...
        self.label.setText(_translate("Widget", "Edição de professos"))
        ...
        self.titulo_forma_admissao.setText(_translate("Widget", "Forma de Admissão"))
        self.titulo_ativo.setText(_translate("Widget", "Ativo"))
        self.ativo_sim.setText(_translate("Widget", "SIM"))
        self.ativo_nao.setText(_translate("Widget", "NÃO"))
    ...
    def carregar_dados_professo(self, dados):
        ...
        # Gênero (M ou F) → marcar e bloquear edição
        if dados['genero'] == 'Maculino':
            self.radioButton.setChecked(True)
        elif dados['genero'] == 'Feminino':
            self.radioButton_2.setChecked(True)

        # 🔒 desabilitar edição do gênero
    ...
    def selecionar_novo_pdf(self):
        ...
        if arquivo:
            try:
                # Lê o conteúdo do PDF como binário
                ...
                QMessageBox.information(
                    self,
                    "Sucesso",
                    f"O arquivo foi substituído com sucesso por:\n{arquivo}"
                )

            except Exception as e:
                QMessageBox.critical(self, "Erro", f"Erro ao substituir o arquivo:\n{e}")
    def pegar_dados_professo(self):
            """Pega os dados do formulário e retorna um dicionário."""
            from PyQt6.QtCore import QDate
